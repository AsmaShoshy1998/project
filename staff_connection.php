...
<center><h2><font color="Bao564" style="font-family:Algerian;"><b>Hostel Management System</b></font></h2>
 ...
 <center> <font size="5" style="font-family: Comic Sans MS;" style="width:100px;height:45px;"><br>
			<h2 class =" heading">Insert Staff Information </h2>
			<form action="staff_connection.php" method="POST">
	<div class="a">
	<p>Staff_Id:</br>
		<input type="number" name="Staff_Id" value=""></p>
		
	<p>Staff_name:</br>
		<input type="text" name="Staff_name" value=""></p>
	...
	<p>Address:</br>
		...
		<input type="text" name="Staff_Salary" value=""></p>
		<p>Cell_No:</br>
	
		<input type="text" name="Cell_No" value=""></p>
...
$sql="INSERT INTO tb_staff(Staff_Id,Staff_name,Address,Staff_Salary,Cell_No) VALUES('$_POST[Staff_Id]','$_POST[Staff_name]','$_POST[Address]','$_POST[Staff_Salary]','$_POST[Cell_No]')";
