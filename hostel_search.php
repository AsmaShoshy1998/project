...
<center><h2><font color="Bao564" style="font-family:Algerian;"><b>Hostel Management System</b></font></h2>
 ...
 <center> <font size="5" style="font-family: Comic Sans MS;" style="width:100px;height:45px;"><br>
			<h2 class =" heading">Search For Hostel</h2>
			<form action="hostel_result.php" method="POST">
			<div class="a">
	<p>ID:</br>
<?php
...
<option value="pick">Hostel ID</option>
<?php
$sql = mysqli_query($conn, "SELECT Hostel_id From tb_hostel");
$row = mysqli_num_rows($sql);
while ($row = mysqli_fetch_array($sql)){
echo "<option value='". $row['Hostel_id'] ."'>" .$row['Hostel_id'] ."</option>" ;
}
?>
