...
<center><h2><font color="Bao564" style="font-family:Algerian;"><b>Hostel Management System</b></font></h2>
 ...
 <center> <font size="5" style="font-family: Comic Sans MS;" style="width:100px;height:45px;"><br>
			...
			<form action="hostel_update.php" method="POST">
<div class="a">

	<p>Hostel_id:</br>
		<input type="number" name="Hostel_id" value="<?php print $_GET['Hostel_id'];?>" style="text-align:center;opacity:0.8;"readonly/>
	...
	<p>No_of_Students:</br>
		...
		<input type="number" name="Location" value=""></p>
