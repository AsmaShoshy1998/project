...
<center><h2><font color="Bao564" style="font-family:Algerian;"><b>Hostel Management System</b></font></h2>
 ...
 <center> <font size="5" style="font-family: Comic Sans MS;" style="width:100px;height:45px;"><br>
			<h2 class =" heading">Update Student Information</h2>
...
$sql="UPDATE tb_student SET Student_name = '".$_POST['Student_name']."', Address ='".$_POST['Address']."',Department ='".$_POST['Department']."',Cell_No ='".$_POST['Cell_No']."',Age ='".$_POST['Age']."',Date_of_Birth ='".$_POST['Date_of_Birth']."',Signature = '".$_POST['Signature']."' WHERE Student_id = '".$_POST['Student_id']."'";
