...
<center><h2><font color="Bao564" style="font-family:Algerian;"><b>Hostel Management System</b></font></h2>
 ...
 <center> <font size="5" style="font-family: Comic Sans MS;" style="width:100px;height:45px;"><br>
			<h2 class =" heading">Search For Room</h2>
			<form action="room_result.php" method="POST">
			<div class="a">
	<p>ID:</br>
<?php
...
<option value="pick">Fee ID</option>
<?php
$sql = mysqli_query($conn, "SELECT Fee_id From tb_fees");
$row = mysqli_num_rows($sql);
while ($row = mysqli_fetch_array($sql)){
echo "<option value='". $row['Fee_id'] ."'>" .$row['Fee_id'] ."</option>" ;
}
?>
