...
<center><h2><font color="Bao564" style="font-family:Algerian;"><b>Hostel Management System</b></font></h2>
 ...
 <center> <font size="5" style="font-family: Comic Sans MS;" style="width:100px;height:45px;"><br>
			<h2 class =" heading">Insert Student Information </h2>
			<form action="student_connection.php" method="POST">
	<div class="a">
<p>Student_id:</br>
		<input type="number" name="Student_id" value=""></p>
...
<p>Signature:</br>
		...
		<input type="date" name="Signature" value=""></p>
...
$sql="INSERT INTO tb_student(Student_id,Student_name,Address,Department,Cell_No,Age,Date_of_Birth,Signature) VALUES('$_POST[Student_id]','$_POST[Student_name]','$_POST[Address]','$_POST[Department]','$_POST[Cell_No]','$_POST[Age]','$_POST[Date_of_Birth]','$_Post[Signature]')";
