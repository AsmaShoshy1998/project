...
<center><h2><font color="Bao564" style="font-family:Algerian;"><b>Hostel Management System</b></font></h2>
 ...
 <center> <font size="5" style="font-family: Comic Sans MS;" style="width:100px;height:45px;"><br>
		<h2 class =" heading">Search Result For Staff</h2>
...
$SQL = "SELECT * FROM tb_staff WHERE Staff_Id LIKE '$term'";
  $result = mysqli_query($connection, $SQL);
  if ($result->num_rows > 0) {
     echo "<table width'600' border='1' cellspacing='1'><tr><th>Staff_Id</th><th>Staff_name</th><th>Address</th><th>Staff_Salary</th><th>Cell_No</th></tr>";
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<tr><td>"  . $row["Staff_Id"]."</td><td>". $row["Staff_name"]."</td><td>".$row["Address"]."</td><td>". $row["Staff_Salary"]."</td><td>". $row["Cell_No"]."</td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
