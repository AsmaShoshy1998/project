...
<center><h2><font color="Bao564" style="font-family:Algerian;"><b>Hostel Management System</b></font></h2>
 ...
 <center> <font size="5" style="font-family: Comic Sans MS;" style="width:100px;height:45px;"><br>
			<h2 class =" heading">Update Fee Information</h2>
			<form action="fee_update.php" method="POST">
<div class="a">

	<p>Fee_id:</br>
		<input type="number" name="Fee_id" value="<?php print $_GET['Fee_id'];?>" style="text-align:center;opacity:0.8;"readonly/>
	...
	<p>House_Rent:</br>
		...
		<input type="number" name="House_Rent" value=""></p>
		<p>Total_Expenses:</br>
	
		<input type="number" name="Total_Expenses" value=""></p>
