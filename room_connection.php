...
<center><h2><font color="Bao564" style="font-family:Algerian;"><b>Hostel Management System</b></font></h2>
 ...
 <center> <font size="5" style="font-family: Comic Sans MS;" style="width:100px;height:45px;"><br>
	...
	<div class="a">
	<p>Room_id:</br>
		<input type="number" name="Room_id" value=""></p>
		
	<p>Capacity:</br>
		<input type="text" name="Capacity" value=""></p>
		
	<p>Name_of_Student:</br>
	
		<input type="number" name="Name_of_Student" value=""></p>
...
$sql="INSERT INTO tb_room(Room_id,Capacity,Name_of_Student) VALUES('$_POST[Room_id]','$_POST[Capacity]','$_POST[Name_of_Student]')";
