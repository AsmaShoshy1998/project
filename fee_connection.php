...
<center><h2><font color="Bao564" style="font-family:Algerian;"><b>Hostel Management System</b></font></h2>
 ...
 <center> <font size="5" style="font-family: Comic Sans MS;" style="width:100px;height:45px;"><br>
			<h2 class =" heading">Insert Room Information </h2>
			<form action="fee_connection.php" method="POST">
	<div class="a">
	<p>Fee_id:</br>
		<input type="number" name="Fee_id" value=""></p>
		
	<p>Food_Price:</br>
		<input type="text" name="Food_Price" value=""></p>
		
	<p>House_Rent:</br>
	
		<input type="text" name="House_Rent" value=""></p>
		<p>Total_Expenses:</br>
	
		<input type="text" name="Total_Expenses" value=""></p>
...
$sql="INSERT INTO tb_fees(Fee_id,Food_Price,House_Rent,Total_Expenses) VALUES('$_POST[Fee_id]','$_POST[Food_Price]','$_POST[House_Rent]','$_POST[Total_Expenses]')";
