...
<center><h2><font color="Bao564" style="font-family:Algerian;"><b>Hostel Management System</b></font></h2>
 ...
 <center> <font size="5" style="font-family: Comic Sans MS;" style="width:100px;height:45px;"><br>
		<h2 class =" heading">Print Hostel Information</h2>
...
$term=$_GET['Student_id'];   

$SQL = "SELECT * FROM tb_student  WHERE Student_id LIKE '$term'";
  $result = mysqli_query($connection, $SQL);
  if ($result->num_rows > 0) {
     echo "<table width'600' border='1' cellspacing='1'><tr><th>Student_id</th><th>Student_name</th><th>Address</th><th>Department</th><th>Cell_No</th><th>Age</th><th>Date_of_Birth</th><th>Signature</th></tr>";
     // output data of each row
     while($row = mysqli_fetch_array($result)) {
         echo "<tr><td>".$row["Student_id"]."</td><td>".$row["Student_name"]."</td><td>".$row["Address"]."</td><td>".$row["Department"]."</td><td>".$row["Cell_No"]."</td><td>".$row["Age"]."</td><td>".$row["Date_of_Birth"]."</td><td>".$row["Signature"]."</td></tr>";
          }
     echo "</table>";
} else {
     echo "0 results";
