...
<center><h2><font color="Bao564" style="font-family:Algerian;"><b>Hostel Management System</b></font></h2>
 ...
 <center> <font size="5" style="font-family: Comic Sans MS;" style="width:100px;height:45px;"><br>
			<h2 class =" heading">Update Staff Information</h2>
			<form action="staff_update.php" method="POST">
<div class="a">

	<p>Staff_Id:</br>
		<input type="number" name="Staff_Id" value="<?php print $_GET['Staff_Id'];?>" style="text-align:center;opacity:0.8;"readonly/>
	...
	<p>Address:</br>
		...
		<input type="number" name="Staff_Salary" value=""></p>
		<p>Cell_No:</br>
